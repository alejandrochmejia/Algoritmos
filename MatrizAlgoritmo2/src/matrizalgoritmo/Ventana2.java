...
int numero;
    ...
    private void OperarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OperarActionPerformed
        ...
        boolean verificacion = MatrizAlgoritmo2.verificacion(tam);
        if (verificacion == false) txtArea.setText("Valor de tamaño no admitido, Por favor ingrese un número del 3 al 10");
            ...
            String[] resultadoMatriz = new String[1];
            resultadoMatriz[0] = "\n\t";
            
            MatrizAlgoritmo2.matrizCreacion(matriz, 0, 0);
            MatrizAlgoritmo2.resultado(matriz, resultadoMatriz, 0, 0);
            txtArea.setText(resultadoMatriz[0]);
            
            int[] Dp = new int[numero];
            MatrizAlgoritmo2.diagonalP(matriz,0,Dp);
            MatrizAlgoritmo2.ordenarP(Dp, 0, numero);
            String resultadoDp = "";
            for (int i = 0; i < numero; i++) {
                resultadoDp = resultadoDp + Dp[i] + " ";
            }
            
            int[] Ds = new int[numero];
            MatrizAlgoritmo2.diagonalS(matriz, 0, Ds);
            int suma = MatrizAlgoritmo2.sumadiaS(matriz, Ds, 0);
            double promedioDs = MatrizAlgoritmo2.promediodiagoS(suma, matriz);
            
            int menorPC = 0;
            menorPC = MatrizAlgoritmo2.menordelaPC(matriz, 0);
            
            int mayorUC = 0;
            mayorUC = MatrizAlgoritmo2.mayordelaUC(matriz, 0);
            
            String resultadopotencia = MatrizAlgoritmo2.potencia(mayorUC, menorPC);
            
            int mayor = 0;
            mayor = MatrizAlgoritmo2.mayordelaMatriz(matriz, 0, 0, mayor);
            System.out.print(mayor + " ");
            String sucesion = MatrizAlgoritmo2.Fibonacci(0, 1, mayor);
            
            principal.setText(resultadoDp);
            promedio.setText(String.valueOf(promedioDs));
            potencia.setText(resultadopotencia);
